...
- **Backend**: See [architecture-backend](docs/tech/architecture-backend.md) for package structure, DDD organization, backend coding practices, database and testing standards.
